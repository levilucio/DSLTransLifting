...
public class ApplyEntity extends ApplyEntityFilter {
	...
	public boolean performApply(InstanceDatabase database, MetaModelDatabase metamodel, InstanceDatabase matchmodel,
		...
		if(getCurrentEntity() == null) {
			...
			if(isImported()) {
				...
				if (currentSolutionPresCond != null)
					presenceConds.put(Integer.toString(ie.hashCode()), currentSolutionPresCond);
